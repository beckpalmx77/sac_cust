...
while ($result_sqlsvr = $stmt_sqlsvr->fetch(PDO::FETCH_ASSOC)) {
    ...
    $sql_find = "SELECT * FROM ims_product_price WHERE product_id = '" . $result_sqlsvr["SKU_CODE"] ."'";
    ...
    if ($nRows > 0) {
        $sql = "UPDATE ims_product_price SET name_t=:name_t , brand_id=:brand_id , pgroup_id=:pgroup_id "
        ...
        $sql = "INSERT INTO ims_product_price(product_key,product_id,pgroup_id,name_t,brand_id,price_code,price) 
